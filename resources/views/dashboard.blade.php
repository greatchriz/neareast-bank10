 ...
 <div class="col-md-6 col-lg-3">
    <div class="iq-card iq-card-block iq-card-stretch iq-card-height"
       ...
       <div class="iq-card-body p-0">
          <a href="#"><img src="/dash/images/booking/03.png" class="img-fluid w-100 rounded shadow" alt=""></a>
       </div>
    </div>
 </div>
 <div class="col-md-6 col-lg-3">
    <div class="iq-card iq-card-block iq-card-stretch iq-card-height"
       style="background: transparent; box-shadow: none;">
       <div class="iq-card-body p-0">
          <a href="#"><img src="/dash/images/booking/04.png" class="img-fluid w-100 rounded shadow" alt=""></a>
       </div>
    </div>
 </div>
 <div class="col-md-6 col-lg-3">
    <div class="iq-card iq-card-block iq-card-stretch iq-card-height"
       style="background: transparent; box-shadow: none;">
       <div class="iq-card-body p-0">
          <a href="#"><img src="/dash/images/booking/05.png" class="img-fluid w-100 rounded shadow" alt=""></a>
       </div>
    </div>
 </div>
 ...
 <div class="col-lg-3 col-md-6">
    <div class="iq-card dash-hover-gradient iq-card-block iq-card-stretch iq-card-height">
       <div class="iq-card-header d-flex justify-content-between border-0">
          <div class="mb-0 font-size-32 text-dark"><i class="ri-bank-line font-weight-light"></i></div>
          <div class="iq-card-header-toolbar d-flex align-items-center">
             <div class="dropdown">
