...
<head>
    ...
    <!-- Vendor Css -->
    <link rel="stylesheet" href="/front_end/css/vendors.css">
    <!-- /Vendor Css -->

    <!-- Plugin Css -->
    <link rel="stylesheet" href="/front_end/css/plugins.css">
    <!-- Plugin Css -->

    <!-- Icons Css -->
    <link rel="stylesheet" href="/front_end/css/icons.css">
    <!-- /Icons Css -->
...
<body>
        ...
        <div class="acavo-responsive-nav">
            ...
            <div class="container">
                <div class="acavo-responsive-menu">
                    <div class="logo">
                        <a href="index.html">
                            <img src="/front_end/images/logo.png" alt="logo">
                        </a>
                    </div>
                </div>
            </div>
                ...
                <nav class="navbar navbar-expand-md navbar-light">
                    ...
                    <div class="collapse navbar-collapse mean-menu">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item"><a href="/login" class="nav-link active">Login </a>

                            </li>

                            <li class="nav-item"><a href="/register" class="nav-link active">Register </a>
            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-3 col-md-4">
                    <div class="footer-logo">
                        <a href="index.html"><img src="/front_end/images/logo.png" alt=""></a>
                    </div>
                </div>
                <!-- /col -->
                <!-- col -->
    ...
    <!-- Vendor Js -->
    <script src="/front_end/js/vendors.js"></script>
    <!-- /Vendor js -->
